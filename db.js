...
function seed() {
  ...
  return {
    nextIds: { user: 4, merchant: 25, offer: 25, voucher: 1000, category: 5, review: 1, merchantAccount: 25 },
    categories: [
    ...
    merchants: [
      { id: 1, name: 'Grand Cinemas Hazmieh', category: 'Entertainment', contact: '+961 76 111 222', initials: 'GC', logoUrl: null },
      { id: 2, name: 'VOX Cinemas City Centre', category: 'Entertainment', contact: '+961 71 222 333', initials: 'VX', logoUrl: null },
      { id: 3, name: 'Codex Adventures', category: 'Entertainment', contact: '+961 3 333 444', initials: 'CX', logoUrl: null },
      { id: 4, name: 'Funscape Sin El Fil', category: 'Entertainment', contact: '+961 1 444 555', initials: 'FS', logoUrl: null },
      { id: 5, name: 'Colonel Karting', category: 'Entertainment', contact: '+961 76 555 666', initials: 'CK', logoUrl: null },
      { id: 6, name: 'Element For Adventure', category: 'Entertainment', contact: '+961 71 666 777', initials: 'EA', logoUrl: null },
      { id: 7, name: 'Em Sherif', category: 'Restaurants', contact: '+961 1 200 100', initials: 'ES', logoUrl: null },
      { id: 8, name: 'BeBabel', category: 'Restaurants', contact: '+961 1 200 200', initials: 'BB', logoUrl: null },
      { id: 9, name: 'Liza', category: 'Restaurants', contact: '+961 1 200 300', initials: 'LZ', logoUrl: null },
      { id: 10, name: 'T-Marbouta', category: 'Restaurants', contact: '+961 1 200 400', initials: 'TM', logoUrl: null },
      { id: 11, name: 'Mayrig', category: 'Restaurants', contact: '+961 1 200 500', initials: 'MY', logoUrl: null },
      { id: 12, name: 'Le Chef', category: 'Restaurants', contact: '+961 1 200 600', initials: 'LC', logoUrl: null },
      { id: 13, name: 'Kimantra Spas', category: 'Spa & Beauty', contact: '+961 4 300 100', initials: 'KM', logoUrl: null },
      { id: 14, name: 'The Royal Spa', category: 'Spa & Beauty', contact: '+961 4 300 200', initials: 'RS', logoUrl: null },
      { id: 15, name: 'Jolie et Co', category: 'Spa & Beauty', contact: '+961 4 300 300', initials: 'JC', logoUrl: null },
      { id: 16, name: 'Smallville Spa & Beauty', category: 'Spa & Beauty', contact: '+961 4 300 400', initials: 'SV', logoUrl: null },
      { id: 17, name: 'Vim & Vigor Badaro', category: 'Spa & Beauty', contact: '+961 4 300 500', initials: 'VV', logoUrl: null },
      { id: 18, name: 'Movenpick Spa', category: 'Spa & Beauty', contact: '+961 4 300 600', initials: 'MP', logoUrl: null },
      { id: 19, name: 'St. Marc Medical & Diagnostic Center', category: 'Medical Checkups', contact: '+961 1 566 222', initials: 'SM', logoUrl: null },
      { id: 20, name: 'MedLab', category: 'Medical Checkups', contact: '+961 1 700 100', initials: 'ML', logoUrl: null },
      { id: 21, name: 'PHD Labs', category: 'Medical Checkups', contact: '+961 1 700 200', initials: 'PD', logoUrl: null },
      { id: 22, name: 'Saint Michel Medical Laboratories', category: 'Medical Checkups', contact: '+961 4 521 601', initials: 'SM', logoUrl: null },
      { id: 23, name: 'Fontana Laboratories', category: 'Medical Checkups', contact: '+961 1 700 400', initials: 'FL', logoUrl: null },
      { id: 24, name: 'ABC Laboratories', category: 'Medical Checkups', contact: '+961 1 700 500', initials: 'AB', logoUrl: null },
    ],
    merchantAccounts: [
      { id: 1, merchantId: 1, role: 'manager', location: null, username: 'grandcinemas', passwordHash: mh },
      { id: 2, merchantId: 2, role: 'manager', location: null, username: 'voxcinemas', passwordHash: mh },
      { id: 3, merchantId: 3, role: 'manager', location: null, username: 'codexadventures', passwordHash: mh },
      { id: 4, merchantId: 4, role: 'manager', location: null, username: 'funscape', passwordHash: mh },
      { id: 5, merchantId: 5, role: 'manager', location: null, username: 'colonelkarting', passwordHash: mh },
      { id: 6, merchantId: 6, role: 'manager', location: null, username: 'elementadventure', passwordHash: mh },
      { id: 7, merchantId: 7, role: 'manager', location: null, username: 'emsherif', passwordHash: mh },
      { id: 8, merchantId: 8, role: 'manager', location: null, username: 'bebabel', passwordHash: mh },
      { id: 9, merchantId: 9, role: 'manager', location: null, username: 'liza', passwordHash: mh },
      { id: 10, merchantId: 10, role: 'manager', location: null, username: 'tmarbouta', passwordHash: mh },
      { id: 11, merchantId: 11, role: 'manager', location: null, username: 'mayrig', passwordHash: mh },
      { id: 12, merchantId: 12, role: 'manager', location: null, username: 'lechef', passwordHash: mh },
      { id: 13, merchantId: 13, role: 'manager', location: null, username: 'kimantraspas', passwordHash: mh },
      { id: 14, merchantId: 14, role: 'manager', location: null, username: 'royalspa', passwordHash: mh },
      { id: 15, merchantId: 15, role: 'manager', location: null, username: 'jolieetco', passwordHash: mh },
      { id: 16, merchantId: 16, role: 'manager', location: null, username: 'smallvillespa', passwordHash: mh },
      { id: 17, merchantId: 17, role: 'manager', location: null, username: 'vimvigor', passwordHash: mh },
      { id: 18, merchantId: 18, role: 'manager', location: null, username: 'movenpickspa', passwordHash: mh },
      { id: 19, merchantId: 19, role: 'manager', location: null, username: 'stmarclab', passwordHash: mh },
      { id: 20, merchantId: 20, role: 'manager', location: null, username: 'medlab', passwordHash: mh },
      { id: 21, merchantId: 21, role: 'manager', location: null, username: 'phdlabs', passwordHash: mh },
      { id: 22, merchantId: 22, role: 'manager', location: null, username: 'saintmichel', passwordHash: mh },
      { id: 23, merchantId: 23, role: 'manager', location: null, username: 'fontanalab', passwordHash: mh },
      { id: 24, merchantId: 24, role: 'manager', location: null, username: 'abclabs', passwordHash: mh },
    ],
    offers: [
